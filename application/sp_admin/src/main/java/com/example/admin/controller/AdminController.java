...
public class AdminController {
    ...
    public ResultData<List<AdminPaginateVO>> paginate(
    ...
    @ApiOperation("添加")
    @PostMapping("/add")
    public ResultData add(@Validated @RequestBody AdminAddDTO adminAddDTO) {
        if (adminService.add(adminAddDTO)!=0) {
            return ResultData.success(null, "添加成功");
        } else {
    ...
    public ResultData<AdminDetailVO> detail(
            @ApiParam(name = "id",value = "管理员id",required = true) @PathVariable("id") Integer userId
    ) {
        return ResultData.success(adminService.detail(userId));
    }
    ...
    public ResultData editSort(@Validated @RequestBody AdminEditSortDTO adminEditSortDTO) {
    ...
    public ResultData editPassword(
    ...
    public ResultData modifyPassword(
    ...
    public ResultData delete(@ApiParam(name = "id",value = "管理员id",required = true) @PathVariable("id") Integer userId) {
